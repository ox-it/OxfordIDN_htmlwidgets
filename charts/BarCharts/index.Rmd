...
# Interactive BarCharts Tutorial
...
It is convenient to proceduralise the creation of these charts by converting the scripts into functions that can easily be called with different parameters, this is particularly useful in Shiny apps. A function for each charting library considered in this document is provided below.
