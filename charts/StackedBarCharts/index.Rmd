...
Note that to ensure that the order of categories in each bar is not modified by the `stacked_bar_chart` function, use `ordering_function = c`. Or take advantage of it being the default argument!
