...
This tutorial uses the `data.frame` below, note that the numbers have been specially chosen to have both varying range and variance for later comparison purposes. As is common when working with data.frames, we override the default behaviour of converting all strings into factors using the argument `stringsAsFactors`.
