...
Where there are multiple measures (numerical values) for each category (or *dimension*), there are therefore two interesting stacked bar charts that can be generated:
