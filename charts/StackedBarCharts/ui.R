...
shinyUI(fluidPage(
  wellPanel(
    ...
    "<p>","A thorough overview of the script behind this visualisation is available on ","<a href=https://github.com/ox-it/OxfordIDN_htmlwidgets/tree/master/charts/BarCharts>GitHub</a>,"," you can also see what code is responsible for which operation in this application by selecting \"Show Code\""
      ))
  ),
  sidebarLayout(
