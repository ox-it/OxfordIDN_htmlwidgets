...
A diverse (but not complete) comparison of the chart types and htmlwidget libraries available from CRAN is provided [here](http://ox-it.github.io/LiveData_htmlwidgets/htmlwidget-comparisons) in addition to a number of interactive elements to assist in tool selection. 
