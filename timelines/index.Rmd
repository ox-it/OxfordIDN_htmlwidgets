...
This tutorial demonstrates how to create interactive timelines (or Gantt charts) like the one below using a variety of different libraries, currently including; [ggplot2](http://ggplot2.org) and [plotly](http://plot.ly). An interactive shiny application containing a plotly chart is available here: <a href="https://livedataoxford.shinyapps.io/htmlwidget_template_timeline/">https://livedataoxford.shinyapps.io/htmlwidget_template_timeline/</a>. Note that the [googleVis](https://github.com/mages/googleVis) library is capable of generating timelines but these depend on Flash and are therefore not covered in this tutorial.
...
A shiny app containing an interactive version of the plotly chart above is available here: <a href="https://livedataoxford.shinyapps.io/htmlwidget_template_timeline/">https://livedataoxford.shinyapps.io/htmlwidget_template_timeline/</a>.
